...
```{r setup, cache=TRUE}
# Set the working directory to the location of the .Rmd file
...
if (!dir.exists(params$output_dir)) dir.create(params$output_dir)
```
<br>
<br>
...
NOTE: Following steps are just for the purpose of this exercise. For more detailed examples and more comprehansive overview of DEA refer to [DESeq2 vignette](https://bioconductor.org/packages/devel/bioc/vignettes/DESeq2/inst/doc/DESeq2.html#indfilt).
