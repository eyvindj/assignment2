...
# Your code here
files_list <- list.files(path="timeseries_data/", pattern = "\\.csv$", full.names = TRUE, recursive = T)
files_list
...
# Your code here
data_list <- map(files_list, ~ read_csv(.x))
data_list
...
```{r}
# Use mdn_df" data frame and ggplot2() function to create a line plot of "Mdn_value" for each "Date" in "mdf_df" data frame. 
